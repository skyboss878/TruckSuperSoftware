...
export default function AIAssistant() {
  ...
  async function sendMessage() {
    ...
    const systemPrompt = `You are an AI assistant for Smith's Freight Hub, a trucking company management system. You have access to real-time data from the database. Answer questions clearly and concisely. When showing numbers, be specific. Format data in a readable way.
