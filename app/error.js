...
export default function GlobalError({ error, reset }) {
  useEffect(() => {
    console.error('[TruckSuperSoftware] Unhandled error:', error)
  }, [error])
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#050c14', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24, textAlign: 'center' }}>
      ...
      <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 14, margin: '0 0 24px' }}>TruckSuperSoftware encountered an unexpected error.</p>
